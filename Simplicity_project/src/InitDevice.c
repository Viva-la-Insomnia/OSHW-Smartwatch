...
extern void PORTIO_enter_DefaultMode_from_RESET(void) {
	...
	/* Pin PA9 is configured to Input enabled with pull-up and filter */
	GPIO->P[0].MODEH = (GPIO->P[0].MODEH & ~_GPIO_P_MODEH_MODE9_MASK)
			| GPIO_P_MODEH_MODE9_INPUTPULLFILTER;
	GPIO->P[0].DOUT |= (1 << 9);

	/* Pin PA10 is configured to Input enabled with pull-up and filter */
	...
	/* Pin PD8 is configured to Input enabled with pull-up and filter */
	GPIO->P[3].MODEH = (GPIO->P[3].MODEH & ~_GPIO_P_MODEH_MODE8_MASK)
			| GPIO_P_MODEH_MODE8_INPUTPULLFILTER;
	GPIO->P[3].DOUT |= (1 << 8);
	// [Port D Configuration]$
	...
	GPIO->P[5].CTRL = (GPIO->P[5].CTRL & ~_GPIO_P_CTRL_DRIVEMODE_MASK)
			| GPIO_P_CTRL_DRIVEMODE_LOW;
